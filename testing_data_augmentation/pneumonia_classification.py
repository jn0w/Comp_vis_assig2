...
if fit:
    ...
    # Mild geometric augmentation only — tested strong augmentation with
    # RandomContrast(0.12) and RandomBrightness(0.12) but it dropped accuracy
    # from ~78.5% to ~75.3%. Contrast/brightness changes distort lung texture
    # in ways that don't match real X-ray variation.
